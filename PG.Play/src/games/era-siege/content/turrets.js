...
export const TURRETS = [
  // ── Era 1 — Ember Tribe ────────────────────────────────────────
  {
    ...
    visual: { baseColor: '#1c2030', barrelColor: '#cdb89a', kind: 'crossbow' },
  ...
  },
  {
    ...
    projectileId: 'bone-shard',
    visual: { baseColor: '#1f2434', barrelColor: '#fff1d2', kind: 'crossbow' },
  ...
  },
  {
    ...
    visual: { baseColor: '#161a26', barrelColor: '#a26830', kind: 'cannon' },
  ...
  },
  {
    ...
    projectileId: 'crossbow-bolt',
    visual: { baseColor: '#1c2030', barrelColor: '#c24237', kind: 'cannon' },
  ...
  // ── Era 3 — Sun Foundry ────────────────────────────────────────
  {
    ...
    projectileId: 'mortar-shell',
    visual: { baseColor: '#1f2434', barrelColor: '#ffcb6b', kind: 'cannon' },
  ...
  },
  {
    ...
    projectileId: 'mortar-shell',
    visual: { baseColor: '#23283a', barrelColor: '#ffcb6b', kind: 'cannon' },
  ...
  },
  {
    ...
    projectileId: 'mortar-shell',
    visual: { baseColor: '#161c2a', barrelColor: '#ffd97a', kind: 'cannon' },
