    ...
    <div className="es-era">
      ...
      {next && (
        <button
          ...
          onClick={onEvolve}
          disabled={!canDo}
          title={`Evolve into ${nextName} — ${next.evolveCost}g, ${next.xpToEvolve} XP`}
          aria-label={`Evolve into ${nextName}, ${next.evolveCost} gold`}>
          <span>Evolve</span>
