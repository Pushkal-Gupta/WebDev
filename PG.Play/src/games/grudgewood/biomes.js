...
export const BIOMES = {
  mosswake: {
    ...
    sun: { color: c('#ffe6c0'), intensity: 1.25, angle: [0.6, -0.7, 0.4] },
  ...
  trickster: {
    ...
    sun: { color: c('#fff4dc'), intensity: 1.35, angle: [0.5, -0.8, 0.3] },
  ...
  rotbog: {
    ...
    sun: { color: c('#c4e0d2'), intensity: 1.05, angle: [0.3, -0.6, 0.7] },
  ...
  cliffside: {
    ...
    sun: { color: c('#eef2f8'), intensity: 1.2, angle: [0.7, -0.5, 0.2] },
  ...
  heart: {
    ...
    sun: { color: c('#ffd0a0'), intensity: 1.15, angle: [0.2, -0.5, 0.8] },
  ...
  sanctum: {
    ...
    sun: { color: c('#f4e0ff'), intensity: 1.18, angle: [0.2, -0.9, 0.0] },
