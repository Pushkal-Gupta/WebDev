...
def pca(X, k):
    ...
    return components, projected, eigvals[order[:k]]`,lesson:{to:"/ml/foundations/pca",label:"Read the PCA lesson"}}];function E(){const[o,p]=r.useState(i[0].id),[n,l]=r.useState({}),a=r.useMemo(()=>i.find(t=>t.id===o)||i[0],[o]),m=t=>l(s=>({...s,[t]:!s[t]})),g=a.icon;return e.jsxs("div",{className:"forge-arena",children:[e.jsx(b,{items:[{label:"PGForge",to:"/ml"},{label:"Arena"}]}),e.jsxs("header",{className:"forge-arena-header",children:[e.jsx("h1",{className:"forge-arena-h1",children:"Arena"}),e.jsx("p",{className:"forge-arena-intro",children:"Eight ML algorithms to implement from scratch — pick one for its objective, math, hints, and a starter stub."})]}),e.jsxs("div",{className:"forge-arena-layout",children:[e.jsx("aside",{className:"forge-arena-list",children:i.map((t,s)=>{const u=t.icon,f=t.id===o;return e.jsxs("button",{type:"button",onClick:()=>{p(t.id),l({})},className:`forge-arena-item ${f?"active":""}`,children:[e.jsx("span",{className:"forge-arena-item-thumb",children:e.jsx(y,{kind:C[t.id]||"auto",seed:t.title,index:s,label:t.tags[0]})}),e.jsxs("span",{className:"forge-arena-item-body",children:[e.jsxs("span",{className:"forge-arena-item-head",children:[e.jsx(u,{size:15,className:"forge-arena-item-icon"}),e.jsx("span",{className:"forge-arena-item-title",children:t.title})]}),e.jsx("span",{className:`forge-arena-pill ${t.difficulty}`,children:t.difficulty})]})]},t.id)})}),e.jsxs("section",{className:"forge-arena-detail",children:[e.jsxs("div",{className:"forge-detail-head",children:[e.jsx(g,{size:26,className:"forge-detail-icon"}),e.jsxs("div",{children:[e.jsx("h2",{className:"forge-detail-title",children:a.title}),e.jsxs("div",{className:"forge-detail-tags",children:[e.jsx("span",{className:`forge-arena-pill ${a.difficulty}`,children:a.difficulty}),a.tags.map(t=>e.jsx("span",{className:"forge-arena-tag",children:t},t))]})]})]}),e.jsxs("div",{className:"forge-detail-block",children:[e.jsxs("div",{className:"forge-detail-label",children:[e.jsx(h,{size:13})," Objective"]}),e.jsx("p",{className:"forge-detail-text",children:a.objective})]}),e.jsxs("div",{className:"forge-detail-block",children:[e.jsxs("div",{className:"forge-detail-label",children:[e.jsx(d,{size:13})," Math & intuition"]}),e.jsx("p",{className:"forge-detail-text",children:a.math})]}),e.jsxs("div",{className:"forge-detail-block",children:[e.jsxs("div",{className:"forge-detail-label",children:[e.jsx(X,{size:13})," Input / output"]}),e.jsxs("p",{className:"forge-detail-text",children:[e.jsx("span",{className:"forge-detail-io-key",children:"in"})," ",a.io.input]}),e.jsxs("p",{className:"forge-detail-text",children:[e.jsx("span",{className:"forge-detail-io-key",children:"out"})," ",a.io.output]})]}),e.jsxs("div",{className:"forge-detail-block",children:[e.jsxs("div",{className:"forge-detail-label",children:[e.jsx(d,{size:13})," Hints"]}),e.jsx("div",{className:"forge-hints",children:a.hints.map((t,s)=>e.jsxs("div",{className:"forge-hint",children:[e.jsxs("button",{type:"button",className:"forge-hint-toggle",onClick:()=>m(s),children:[n[s]?e.jsx(z,{size:14}):e.jsx(c,{size:14}),e.jsxs("span",{className:"forge-hint-num",children:["Hint ",s+1]})]}),n[s]&&e.jsx("p",{className:"forge-hint-text",children:t})]},s))})]}),e.jsxs("div",{className:"forge-detail-block",children:[e.jsxs("div",{className:"forge-detail-label",children:[e.jsx(T,{size:13})," Starter (Python)"]}),e.jsx("pre",{className:"forge-detail-code",children:a.starter})]}),e.jsxs("div",{className:"forge-detail-block",children:[e.jsxs("div",{className:"forge-detail-label",children:[e.jsx(K,{size:13})," Expected approach"]}),e.jsx("p",{className:"forge-detail-text",children:a.approach}),a.lesson&&e.jsxs(W,{to:a.lesson.to,className:"forge-detail-link",children:[a.lesson.label," ",e.jsx(c,{size:14})]})]})]})]})]})}export{E as default};
