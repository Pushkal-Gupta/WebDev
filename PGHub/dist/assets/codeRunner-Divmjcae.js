import{s as D}from"./index-DHHeY8Yn.js";const b={int:{jsdoc:"number",java:"int",cpp:"int",go:"int",c:"int",swift:"Int",kotlin:"Int",rust:"i64",typescript:"number"},float:{jsdoc:"number",java:"double",cpp:"double",go:"float64",c:"double",swift:"Double",kotlin:"Double",rust:"f64",typescript:"number"},str:{jsdoc:"string",java:"String",cpp:"string",go:"string",c:"char*",swift:"String",kotlin:"String",rust:"String",typescript:"string"},bool:{jsdoc:"boolean",java:"boolean",cpp:"bool",go:"bool",c:"bool",swift:"Bool",kotlin:"Boolean",rust:"bool",typescript:"boolean"},"List[int]":{jsdoc:"number[]",java:"int[]",cpp:"vector<int>",go:"[]int",c:"int*",swift:"[Int]",kotlin:"IntArray",rust:"Vec<i64>",typescript:"number[]"},"List[str]":{jsdoc:"string[]",java:"String[]",cpp:"vector<string>",go:"[]string",c:"char**",swift:"[String]",kotlin:"Array<String>",rust:"Vec<String>",typescript:"string[]"},"List[List[int]]":{jsdoc:"number[][]",java:"int[][]",cpp:"vector<vector<int>>",go:"[][]int",c:"int**",swift:"[[Int]]",kotlin:"Array<IntArray>",rust:"Vec<Vec<i64>>",typescript:"number[][]"},"List[List[str]]":{jsdoc:"string[][]",java:"String[][]",cpp:"vector<vector<string>>",go:"[][]string",c:"char***",swift:"[[String]]",kotlin:"Array<Array<String>>",rust:"Vec<Vec<String>>",typescript:"string[][]"},"List[bool]":{jsdoc:"boolean[]",java:"boolean[]",cpp:"vector<bool>",go:"[]bool",c:"bool*",swift:"[Bool]",kotlin:"BooleanArray",rust:"Vec<bool>",typescript:"boolean[]"},ListNode:{jsdoc:"ListNode",java:"ListNode",cpp:"ListNode*",go:"*ListNode",c:"struct ListNode*",swift:"ListNode?",kotlin:"ListNode?",rust:"Option<Box<ListNode>>",typescript:"ListNode | null"},"Optional[ListNode]":{jsdoc:"ListNode",java:"ListNode",cpp:"ListNode*",go:"*ListNode",c:"struct ListNode*",swift:"ListNode?",kotlin:"ListNode?",rust:"Option<Box<ListNode>>",typescript:"ListNode | null"},TreeNode:{jsdoc:"TreeNode",java:"TreeNode",cpp:"TreeNode*",go:"*TreeNode",c:"struct TreeNode*",swift:"TreeNode?",kotlin:"TreeNode?",rust:"Option<Rc<RefCell<TreeNode>>>",typescript:"TreeNode | null"},"Optional[TreeNode]":{jsdoc:"TreeNode",java:"TreeNode",cpp:"TreeNode*",go:"*TreeNode",c:"struct TreeNode*",swift:"TreeNode?",kotlin:"TreeNode?",rust:"Option<Rc<RefCell<TreeNode>>>",typescript:"TreeNode | null"}},q=r=>{var s;return((s=b[r])==null?void 0:s.java)||r},x=r=>{var s;return((s=b[r])==null?void 0:s.jsdoc)||r},I=r=>{var s;return((s=b[r])==null?void 0:s.cpp)||r},O=r=>{var s;return((s=b[r])==null?void 0:s.go)||r},z=r=>{var s;return((s=b[r])==null?void 0:s.c)||r},E=r=>{var s;return((s=b[r])==null?void 0:s.swift)||r},B=r=>{var s;return((s=b[r])==null?void 0:s.kotlin)||r},C=r=>{var s;return((s=b[r])==null?void 0:s.rust)||r},R=r=>{var s;return((s=b[r])==null?void 0:s.typescript)||r},N=r=>r==="ListNode"||r==="Optional[ListNode]",S=r=>r==="TreeNode"||r==="Optional[TreeNode]",y=r=>r.replace(/[A-Z]/g,(s,a)=>a===0?s.toLowerCase():"_"+s.toLowerCase()),J=`# Definition for singly-linked list.
# class ListNode:
 ...
 * }
 */
`;function pt(r,s,a,i){var v,L,w,m;if(!s||!a)return null;a.length===2&&((v=a[0])==null?void 0:v.type)==="List[int]"&&((L=a[0])==null?void 0:L.name)==="values"&&((w=a[1])==null?void 0:w.type)==="int"&&((m=a[1])==null?void 0:m.name)==="pos"&&(a=[{name:"head",type:"Optional[ListNode]"}]);const h=[...a.map(o=>o.type),i||""],d=h.some(N),g=h.some(S);if(r==="python"){const o=a.map(c=>`${c.name}: ${c.type}`).join(", ");let l="";return d&&(l+=J),g&&(l+=U),`${l}class Solution:
    def ${s}(self, ${o}) -> ${i}:
...
`;function lt(r){var s,a,i,u;return Array.isArray(r)&&r.length===2&&((s=r[0])==null?void 0:s.type)==="List[int]"&&((a=r[0])==null?void 0:a.name)==="values"&&((i=r[1])==null?void 0:i.type)==="int"&&((u=r[1])==null?void 0:u.name)==="pos"}function ft(r,s,a,i,u,h={}){if(!a||!i)return r;const d=lt(i),g=d?"head":i.map(m=>m.name).join(", "),v=N(u),L=S(u),w=Math.max(1,Number(h.multiCaseCount)||1);if(s==="python"){if(i.length===1&&i[0].name==="operations"&&i[0].type&&i[0].type.startsWith("List[List"))return["import sys, json","from typing import List, Optional, Dict, Tuple, Set",P,r,"","_ops = json.loads(sys.stdin.read().strip())","_results = []","_instance = None","for _op in _ops:","    _name = _op[0]","    _args = _op[1:]","    if _instance is None:","        _cls = globals()[_name]","        _instance = _cls(*_args)","        _results.append(None)","    else:","        _ret = getattr(_instance, _name)(*_args)","        _results.append(_ret)","print(json.dumps(_results))"].join(`
`);const o=d?["_values = json.loads(_lines[0])","_pos = int(_lines[1].strip())","head = _to_list_cycle(_values, _pos)"].join(`
`):i.map((c,f)=>N(c.type)?`${c.name} = _to_list(json.loads(_lines[${f}]))`:S(c.type)?`${c.name} = _to_tree(json.loads(_lines[${f}]))`:`${c.name} = json.loads(_lines[${f}])`).join(`
`);let l;return v?l="print(json.dumps(_from_list(_result)))":L?l="print(json.dumps(_from_tree(_result)))":l=["if isinstance(_result, bool):","    print(str(_result).lower())","elif _result is None:",'    print("null")',"elif isinstance(_result, str):","    print(_result)","else:","    print(json.dumps(_result))"].join(`
...
`):i.map((l,c)=>N(l.type)?`const ${l.name} = _toList(JSON.parse(_lines[${c}]));`:S(l.type)?`const ${l.name} = _toTree(JSON.parse(_lines[${c}]));`:`const ${l.name} = JSON.parse(_lines[${c}]);`).join(`
`);let o;return v?o="console.log(JSON.stringify(_fromList(_result)));":L?o="console.log(JSON.stringify(_fromTree(_result)));":o="console.log(JSON.stringify(_result));",[X,r,"","const _lines = require('fs').readFileSync('/dev/stdin', 'utf8').trim().split('\\n');",m,`const _result = ${a}(${g});`,o].join(`
...
`):L?[`        TreeNode _result = sol.${a}(${g});`,"        System.out.println(_jsonTree(_result));"].join(`
...
`):L?[`                TreeNode _result = sol.${a}(${g});`,"                _out.append(_jsonTree(_result));"].join(`
...
`):N(u)?p=[`    struct ListNode* _result = ${a}(${e.join(", ")});`,"    _pgc_print_list(_result);","    putchar('\\n');"].join(`
...
`)}if(s==="go"){if(i.length===1&&i[0].name==="operations"&&i[0].type&&i[0].type.startsWith("List[List"))return r;const o=[],l=d?["head"]:i.map(e=>e.name);d?(o.push("    var _values []int"),o.push("    json.Unmarshal([]byte(_lines[0]), &_values)"),o.push("    _pos, _ := strconv.Atoi(strings.TrimSpace(_lines[1]))"),o.push("    head := _pgc_arr_to_list_cycle(_values, _pos)")):i.forEach((e,p)=>{const n=`_lines[${p}]`;e.type==="int"?(o.push(`    var ${e.name} int`),o.push(`    json.Unmarshal([]byte(${n}), &${e.name})`)):e.type==="float"?(o.push(`    var ${e.name} float64`),o.push(`    json.Unmarshal([]byte(${n}), &${e.name})`)):e.type==="bool"?(o.push(`    var ${e.name} bool`),o.push(`    json.Unmarshal([]byte(${n}), &${e.name})`)):e.type==="str"?(o.push(`    var ${e.name} string`),o.push(`    json.Unmarshal([]byte(${n}), &${e.name})`)):e.type==="List[int]"?(o.push(`    var ${e.name} []int`),o.push(`    json.Unmarshal([]byte(${n}), &${e.name})`)):e.type==="List[bool]"?(o.push(`    var ${e.name} []bool`),o.push(`    json.Unmarshal([]byte(${n}), &${e.name})`)):e.type==="List[str]"?(o.push(`    var ${e.name} []string`),o.push(`    json.Unmarshal([]byte(${n}), &${e.name})`)):e.type==="List[List[int]]"?(o.push(`    var ${e.name} [][]int`),o.push(`    json.Unmarshal([]byte(${n}), &${e.name})`)):e.type==="List[List[str]]"?(o.push(`    var ${e.name} [][]string`),o.push(`    json.Unmarshal([]byte(${n}), &${e.name})`)):N(e.type)?(o.push(`    var ${e.name}Arr []int`),o.push(`    json.Unmarshal([]byte(${n}), &${e.name}Arr)`),o.push(`    ${e.name} := _pgc_arr_to_list(${e.name}Arr)`)):S(e.type)?o.push(`    ${e.name} := _pgc_parse_tree_line(${n})`):(o.push(`    var ${e.name} interface{}`),o.push(`    json.Unmarshal([]byte(${n}), &${e.name})`))});let c;N(u)?c=["    _arr := _pgc_list_to_arr(_result)","    fmt.Println(_pgc_jsonify(_arr))"].join(`
...
`)}if(s==="swift"){if(i.length===1&&i[0].name==="operations"&&i[0].type&&i[0].type.startsWith("List[List"))return r;const o=(t,e,p)=>{const n=`_v${p}`,_=`        let ${n}: Any? = _pgcReadJSON(_lines[${p}])`;return e==="int"?`${_}
        ...
        let ${t}: [[String]] = _pgcStrStrArr(${n})`:N(e)?`${_}
...
`),c=d?"head":i.map(t=>t.name).join(", ");let f;return v?f=`        let _arr = _pgcListToArr(_result)
        print(_pgcJsonify(_arr))`:L?f="        print(_pgcTreeToArr(_result))":u==="bool"?f='        print(_result ? "true" : "false")':u==="int"?f="        print(_result)":f="        print(_pgcJsonify(_result))",[nt,r,"","let _input = FileHandle.standardInput.availableData",'let _raw = String(data: _input, encoding: .utf8) ?? ""','let _lines = _raw.split(separator: "\\n", omittingEmptySubsequences: false).map { String($0) }',"","do {",l,`    let _result = Solution().${a}(${c})`,f,"}"].join(`
`)}if(s==="kotlin"){if(i.length===1&&i[0].name==="operations"&&i[0].type&&i[0].type.startsWith("List[List"))return r;const o=(t,e,p)=>{const n=`_lines[${p}]`;return e==="int"?`        val ${t}: Int = ${n}.trim().toInt()`:e==="float"?`        val ${t}: Double = ${n}.trim().toDouble()`:e==="bool"?`        val ${t}: Boolean = ${n}.trim() == "true"`:e==="str"?`        val ${t}: String = PGC.stripQuotes(${n})`:e==="List[int]"?`        val ${t}: IntArray = PGC.parseIntArr(${n})`:e==="List[bool]"?`        val ${t}: BooleanArray = PGC.parseBoolArr(${n})`:e==="List[str]"?`        val ${t}: Array<String> = PGC.parseStrArr(${n})`:e==="List[List[int]]"?`        val ${t}: Array<IntArray> = PGC.parseIntIntArr(${n})`:e==="List[List[str]]"?`        val ${t}: Array<Array<String>> = PGC.parseStrStrArr(${n})`:N(e)?`        val ${t}: ListNode? = PGC.arrToList(PGC.parseIntArr(${n}))`:S(e)?`        val ${t}: TreeNode? = PGC.arrToTree(PGC.parseTreeTokens(${n}))`:`        val ${t}: String = ${n}`},l=d?["        val _values: IntArray = PGC.parseIntArr(_lines[0])","        val _pos: Int = _lines[1].trim().toInt()","        val head: ListNode? = PGC.arrToListCycle(_values, _pos)"].join(`
`):i.map((t,e)=>o(t.name,t.type,e)).join(`
`),c=d?"head":i.map(t=>t.name).join(", ");let f;return v?f="    println(PGC.listToStr(_result))":L?f="    println(PGC.treeToStr(_result))":f="    println(PGC.jsonify(_result))",[it,r,"","fun main() {","    val _lines = System.`in`.bufferedReader().readLines()",l,`    val _result = Solution().${a}(${c})`,f,"}"].join(`
`)}if(s==="rust"){if(i.length===1&&i[0].name==="operations"&&i[0].type&&i[0].type.startsWith("List[List"))return r;const o=y(a),l=(e,p,n)=>{const _=y(e),$=`&_lines[${n}]`;return p==="int"?`    let ${_}: i64 = _pgc_parse_i64(${$});`:p==="float"?`    let ${_}: f64 = _pgc_parse_f64(${$});`:p==="bool"?`    let ${_}: bool = _pgc_parse_bool(${$});`:p==="str"?`    let ${_}: String = _pgc_parse_str(${$});`:p==="List[int]"?`    let ${_}: Vec<i64> = _pgc_parse_vi(${$});`:p==="List[bool]"?`    let ${_}: Vec<bool> = _pgc_parse_vb(${$});`:p==="List[str]"?`    let ${_}: Vec<String> = _pgc_parse_vs(${$});`:p==="List[List[int]]"?`    let ${_}: Vec<Vec<i64>> = _pgc_parse_vvi(${$});`:p==="List[List[str]]"?`    let ${_}: Vec<Vec<String>> = _pgc_parse_vvs(${$});`:N(p)?`    let ${_}: Option<Box<ListNode>> = _pgc_arr_to_list(&_pgc_parse_vi(${$}));`:S(p)?`    let ${_}: Option<Rc<RefCell<TreeNode>>> = _pgc_arr_to_tree(&_pgc_parse_tree_tokens(${$}));`:`    let ${_}: String = _lines[${n}].clone();`},c=d?["    let _values: Vec<i64> = _pgc_parse_vi(&_lines[0]);","    let _pos: i64 = _pgc_parse_i64(&_lines[1]);","    let head: Option<Box<ListNode>> = _pgc_arr_to_list_cycle(&_values, _pos);"].join(`
