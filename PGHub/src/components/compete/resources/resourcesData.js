// Curated, internal-first resource shelf for the compete hub. Internal links
// point to real PGcode routes; external groups list well-known, stable references.

export const RESOURCE_GROUPS = [
  {
    key: 'cp-foundations',
    title: 'Competitive foundations',
    blurb: 'The core toolkit every contest problem leans on.',
    hue: 'var(--hue-violet)',
    items: [
  ...
  },
  {
    ...
    blurb: 'Drill rated problems and track your rating over time.',
    hue: 'var(--hue-sky)',
    items: [
      ...
      { label: 'Contest calendar', to: '/compete', kind: 'internal' },
