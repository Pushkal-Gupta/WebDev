...
// raw backend error to the user — always route it through sanitizeError, which maps known
...
export function sanitizeError(e, fallback = 'Something went wrong. Please try again.') {
