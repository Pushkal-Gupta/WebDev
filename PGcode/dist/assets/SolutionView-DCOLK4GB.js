...
};`,complexity:{time:"O(log n)",space:"O(1)"},approach:"STL `std::lower_bound` does this exact search in 1 line — but writing it yourself is the canonical interview answer."}}}};function Me({problem:s,activeLang:a}){var m,b,N,v,f;const[c,n]=$.useState([]),[r,i]=$.useState(!0),[t,l]=$.useState(a||"python"),[d,g]=$.useState(null);$.useEffect(()=>{a&&l(a)},[a]);const y=async(u,k)=>{if(k)try{await navigator.clipboard.writeText(k),g(u),setTimeout(()=>g(S=>S===u?null:S),1500)}catch{}},h=s==null?void 0:s.id;if($.useEffect(()=>{h&&(async()=>{i(!0);try{const{data:u}=await Z.from("PGcode_solution_approaches").select("*").eq("problem_id",h).order("approach_number",{ascending:!0});n(u||[])}catch(u){console.error("Failed to load solution approaches:",u)}finally{i(!1)}})()},[h]),r)return e.jsx("div",{className:"sv-loading",children:"Loading solutions..."});const p={python:"Python",javascript:"JavaScript",java:"Java",cpp:"C++"},x=s.solutions&&Object.keys(s.solutions).length>0?s.solutions:((m=ke[s.id])==null?void 0:m.solutions)||null;if(c.length===0&&x)return e.jsxs("div",{className:"sv-container",children:[e.jsxs("h2",{className:"sv-problem-title",children:[s.name," — reference solution"]}),e.jsxs("div",{className:"sv-approach",children:[e.jsxs("div",{className:"sv-subsection",children:[e.jsxs("div",{className:"sv-code-header",children:[e.jsx("div",{className:"sv-lang-tabs",children:["python","javascript","java","cpp"].map(u=>{var k;return e.jsx("button",{className:`sv-lang-tab ${t===u?"active":""}`,onClick:()=>l(u),disabled:!((k=x[u])!=null&&k.code),children:p[u]},u)})}),e.jsxs("button",{className:`sv-copy-btn ${d==="fb"?"copied":""}`,onClick:()=>{var u;return y("fb",(u=x[t])==null?void 0:u.code)},disabled:!((b=x[t])!=null&&b.code),children:[d==="fb"?e.jsx(T,{size:13}):e.jsx(X,{size:13}),e.jsx("span",{children:d==="fb"?"Copied":"Copy"})]})]}),(N=x[t])!=null&&N.code?e.jsx("pre",{className:"sv-code-block",children:e.jsx("code",{children:x[t].code})}):e.jsxs("div",{className:"sv-code-empty",children:["No ",p[t]," solution yet."]})]}),((v=x[t])==null?void 0:v.approach)&&e.jsxs("div",{className:"sv-subsection",children:[e.jsx("h4",{className:"sv-subtitle",children:"Approach"}),e.jsx("p",{className:"sv-text",children:x[t].approach})]}),((f=x[t])==null?void 0:f.complexity)&&e.jsxs("div",{className:"sv-complexity",children:[e.jsxs("span",{children:[e.jsx("strong",{children:"Time:"})," ",x[t].complexity.time]}),e.jsxs("span",{children:[e.jsx("strong",{children:"Space:"})," ",x[t].complexity.space]})]})]})]});if(c.length===0)return e.jsxs("div",{className:"sv-container",children:[s.solution_video_url&&e.jsxs("div",{className:"sv-section",children:[e.jsx("h3",{className:"sv-section-title",children:"Video Explanation"}),e.jsx("div",{className:"sv-video-wrap",children:e.jsx("iframe",{src:`https://www.youtube.com/embed/${s.solution_video_url}`,title:"Video",allowFullScreen:!0})})]}),e.jsxs("div",{className:"sv-section",children:[e.jsx("h3",{className:"sv-section-title",children:"Visual Dry Run"}),e.jsx(K,{problemId:s.id})]})]});const o={python:"code_python",javascript:"code_javascript",java:"code_java",cpp:"code_cpp"};return e.jsxs("div",{className:"sv-container",children:[e.jsxs("h2",{className:"sv-problem-title",children:[s.name," - Explanation"]}),s.solution_video_url&&e.jsxs("div",{className:"sv-section",children:[e.jsx("h3",{className:"sv-section-title",children:"Video Explanation"}),e.jsx("div",{className:"sv-video-wrap",children:e.jsx("iframe",{src:`https://www.youtube.com/embed/${s.solution_video_url}`,title:"Video",allowFullScreen:!0})})]}),c.map((u,k)=>{let S=[];try{const j=typeof u.algorithm_steps=="string"?JSON.parse(u.algorithm_steps):u.algorithm_steps||[];S=Array.isArray(j)?j:(j==null?void 0:j.steps)||[]}catch{}const M=u[o[t]]||u.code_python||"";return e.jsxs("div",{className:"sv-approach",children:[e.jsxs("h3",{className:"sv-approach-title",children:[k+1,". ",u.approach_name]}),e.jsxs("div",{className:"sv-subsection",children:[e.jsx("h4",{className:"sv-subtitle",children:"Intuition"}),e.jsx("p",{className:"sv-text",children:u.intuition})]}),e.jsxs("div",{className:"sv-subsection",children:[e.jsx("h4",{className:"sv-subtitle",children:"Algorithm"}),e.jsx("ol",{className:"sv-algo-steps",children:S.map((j,C)=>e.jsx("li",{children:j},C))})]}),k===c.length-1&&e.jsxs("div",{className:"sv-subsection",children:[e.jsx("h4",{className:"sv-subtitle",children:"Visual Dry Run"}),e.jsx(K,{problemId:s.id})]}),e.jsxs("div",{className:"sv-subsection",children:[e.jsxs("div",{className:"sv-code-header",children:[e.jsx("div",{className:"sv-lang-tabs",children:["python","javascript","java","cpp"].map(j=>e.jsx("button",{className:`sv-lang-tab ${t===j?"active":""}`,onClick:()=>l(j),children:p[j]},j))}),e.jsxs("button",{className:`sv-copy-btn ${d===u.id?"copied":""}`,onClick:()=>y(u.id,M),disabled:!M,title:M?"Copy code":"No code to copy","aria-label":"Copy code",children:[d===u.id?e.jsx(T,{size:13}):e.jsx(X,{size:13}),e.jsx("span",{children:d===u.id?"Copied":"Copy"})]})]}),M?e.jsx("pre",{className:"sv-code-block",children:e.jsx("code",{children:M})}):e.jsxs("div",{className:"sv-code-empty",children:["No ",p[t]," reference yet for this approach."]})]}),e.jsxs("div",{className:"sv-complexity",children:[e.jsxs("span",{children:[e.jsx("strong",{children:"Time:"})," ",u.time_complexity]}),e.jsxs("span",{children:[e.jsx("strong",{children:"Space:"})," ",u.space_complexity]})]})]},u.id)})]})}export{ke as R,Me as S};
