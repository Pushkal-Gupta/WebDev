...
`);let l;return v?l="print(json.dumps(_from_list(_result)))":N?l="print(json.dumps(_from_tree(_result)))":l=["if isinstance(_result, bool):","    print(str(_result).lower())","elif _result is None:",'    print("null")',"else:","    print(json.dumps(_result))"].join(`
