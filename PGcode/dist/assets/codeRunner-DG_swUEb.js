...
`),["import sys, json","from typing import List, Optional, Dict, Tuple, Set",T,e,"",'_lines = sys.stdin.read().strip().split("\\n")',g,"_sol = Solution()",`_result = _sol.${i}(${u})`,o].join(`
