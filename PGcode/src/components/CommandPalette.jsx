...
const NAV_COMMANDS = [
  { id: 'nav-roadmap',        label: 'Roadmap',           path: '/',                          icon: Map,            keywords: 'graph topics tree dependencies dsa home' },
  { id: 'nav-roadmaps',       label: 'All roadmaps',      path: '/roadmaps',                  icon: Network,        keywords: 'index tracks blind 75 neetcode' },
  { id: 'nav-tutorial',       label: 'DSA Tutorial',      path: '/tutorial',                  icon: GraduationCap,  keywords: 'syllabus full curriculum gfg tutorial' },
  { id: 'nav-learn',          label: 'Concept library',   path: '/learn',                     icon: BookOpen,       keywords: 'concepts deep dives learn' },
  ...
  { id: 'nav-contests',       label: 'Contests',          path: '/contests',                  icon: Trophy,         keywords: 'timed virtual contest leaderboard' },
  { id: 'nav-lists',          label: 'My Lists',          path: '/lists',                     icon: List,           keywords: 'custom playlist favorites' },
  { id: 'nav-history',        label: 'Practice history',  path: '/progress?tab=history',      icon: History,        keywords: 'submissions log accepted attempts' },
  { id: 'nav-notebook',       label: 'Notebook',          path: '/notebook',                  icon: StickyNote,     keywords: 'notes personal annotations wiki' },
  { id: 'nav-review',         label: 'Review queue',      path: '/review',                    icon: RotateCcw,      keywords: 'spaced repetition revisit' },
  { id: 'nav-progress',       label: 'Your activity',     path: '/progress',                  icon: TrendingUp,     keywords: 'stats heatmap mastery achievements progress dashboard' },
