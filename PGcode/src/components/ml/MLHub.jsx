  ...
  return (
    <div className="mlhub">
      <header className="mlhub-hero">
        ...
        <p className="mlhub-sub">How the architectures work — deep nets, attention and transformers, generative models, and RL. For the underlying math, see <Link to="/ml/math" className="mlhub-sub-link">ML Math</Link>.</p>
      </header>
