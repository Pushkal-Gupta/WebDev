...
export const DSA_TUTORIAL = [
  {
    ...
    subsections: [
      { id: 'programming', label: 'Programming',
        items: [
          { kind: 'topic', label: 'Input and Output' },
          { kind: 'topic', label: 'Conditional Statements' },
          { kind: 'topic', label: 'For loop' },
          { kind: 'topic', label: 'While loop' },
          { kind: 'topic', label: 'Function' },
          { kind: 'topic', label: 'Classes and Objects' },
        ],
      },
      { id: 'complexity', label: 'Complexity Analysis',
        items: [
          { kind: 'topic', label: 'Order of Growth' },
          { kind: 'topic', label: 'Asymptotic Analysis' },
          { kind: 'topic', label: 'Big-O / Θ / Ω' },
          { kind: 'topic', label: 'Time Complexity' },
          { kind: 'topic', label: 'Space Complexity' },
        ],
      },
    ],
  },
